...
(
	...
	constraint FK_KH FOREIGN KEY (MaCD) REFERENCES ChuyenDe(MaCD),
	constraint FK_KH2 FOREIGN KEY (MaNV) REFERENCES NhanVien(MaNV)
)
go
...
(
	...
	constraint FK_NguoiHoc FOREIGN KEY (MaNV) REFERENCES NhanVien(MaNV)
)
go
...
(
	[MaHV] nvarchar(15) primary key,
	[MaKH] nvarchar(15),
	[MaNH] nvarchar(15),
	[Diem] float ,
	constraint FK_HocVien1 FOREIGN KEY (MaKH) REFERENCES KhoaHoc(MaKH),
	constraint FK_HocVien2 FOREIGN KEY (MaNH) REFERENCES NguoiHoc(MaNH)
)
go
...
INSERT [dbo].[KhoaHoc] ([MaKH], [MaCD], [HocPhi], [ThoiLuong], [NgayKG], [GhiChu], [MaNV], [NgayTao]) VALUES (3, N'RDB01', 100, 50, CAST(0xBF3D0B00 AS Date), N'', N'NoPT', CAST(0xB53D0B00 AS Date))
...
INSERT [dbo].[KhoaHoc] ([MaKH], [MaCD], [HocPhi], [ThoiLuong], [NgayKG], [GhiChu], [MaNV], [NgayTao]) VALUES (5, N'SER04', 300, 90, CAST(0xBF3D0B00 AS Date), N'', N'PheoNC', CAST(0xB53D0B00 AS Date))
INSERT [dbo].[KhoaHoc] ([MaKH], [MaCD], [HocPhi], [ThoiLuong], [NgayKG], [GhiChu], [MaNV], [NgayTao]) VALUES (6, N'PRO05', 100, 50, CAST(0xBF3D0B00 AS Date), N'', N'TeoNV', CAST(0xB53D0B00 AS Date))
INSERT [dbo].[KhoaHoc] ([MaKH], [MaCD], [HocPhi], [ThoiLuong], [NgayKG], [GhiChu], [MaNV], [NgayTao]) VALUES (7, N'RDB03', 250, 80, CAST(0xBF3D0B00 AS Date), N'', N'NoPT', CAST(0xB53D0B00 AS Date))
...
select [MaNH], [HoTen], CONVERT(nvarchar,NgaySinh,103) AS NgaySinh, [GioiTinh], [DienThoai], [Email], [GhiChu], [MaNV], CONVERT(nvarchar,NgayDK,103) AS NgayDangKy from NguoiHoc

SELECT * FROM KhoaHoc
SELECT * FROM HocVien 11
update [HocVien] set [Diem] = 2.2 where MaHV = 11
INSERT [dbo].[HocVien] ([MaHV], [MaKH], [MaNH], [Diem]) VALUES (1, 2, N'PS01638',null)
INSERT [dbo].[HocVien] ([MaHV], [MaKH], [MaNH], [Diem]) VALUES (2, 2, N'PS02037', 2)
INSERT [dbo].[HocVien] ([MaHV], [MaKH], [MaNH], [Diem]) VALUES (3, 2, N'PS02771', 5)
INSERT [dbo].[HocVien] ([MaHV], [MaKH], [MaNH], [Diem]) VALUES (5, 2, N'PS02930', 6)
INSERT [dbo].[HocVien] ([MaHV], [MaKH], [MaNH], [Diem]) VALUES (7, 2, N'PS02983', 9)
INSERT [dbo].[HocVien] ([MaHV], [MaKH], [MaNH], [Diem]) VALUES (8, 2, N'PS02988',3)
INSERT [dbo].[HocVien] ([MaHV], [MaKH], [MaNH], [Diem]) VALUES (11, 3, N'PS01638', 10)
INSERT [dbo].[HocVien] ([MaHV], [MaKH], [MaNH], [Diem]) VALUES (12, 3, N'PS02037', 7)
INSERT [dbo].[HocVien] ([MaHV], [MaKH], [MaNH]) VALUES (13, 3, N'PS02771')
INSERT [dbo].[HocVien]  VALUES (14, 3, N'PS02867')
INSERT [dbo].[HocVien] VALUES (15, 3, N'PS02930',)
...
SELECT [MaKH], [MaCD], [HocPhi], [ThoiLuong],CONVERT(nvarchar,NgayKG,103)as [NgayKG], [GhiChu], [MaNV], CONVERT(nvarchar,NgayTao,103)as[NgayTao] FROM KhoaHoc
...
select [MaNH], [HoTen],  NgaySinh, [GioiTinh], [DienThoai], [Email], [GhiChu], [MaNV], [NgayDK] from NguoiHoc
...
WHERE NguoiHoc.MaNV = 'TeoNV'

SELECT	MaCD  FROM ChuyenDe where MaCD = 'PRO02'
SELECT MaKH FROM KhoaHoc where MaCD = 'PRO02'
SELECT MaHV FROM HocVien where MaKH =  1


select* from HocVien
select* from KhoaHoc
select* from ChuyenDe
DELETE FROM KhoaHoc WHERE MaCD = 'JAV02'
DELETE FROM HocVien WHERE MaKH = (SELECT MaKH FROM KhoaHoc where MaCD = 'JAV02')
DELETE FROM ChuyenDe WHERE MaCD = 'JAV02'

INSERT [dbo].[ChuyenDe] ([MaCD], [TenCD], [HocPhi], [ThoiLuong], [MoTa]) VALUES (?,?, ?, ?,?)

DELETE FROM HocVien WHERE MaKH = (SELECT MaKH FROM KhoaHoc where MaCD = 'PRO03')
	DELETE FROM KhoaHoc WHERE MaCD = 'PRO03'
	DELETE FROM ChuyenDe WHERE MaCD = 'PRO03'